...
#define ALSA_CONFIG_DIR "/data/develop/android/sysroot/usr/share/alsa"
...
#define ALSA_PKGCONF_DIR "/data/develop/android/sysroot/usr/lib/pkgconfig"

/* directory containing ALSA add-on modules */
#define ALSA_PLUGIN_DIR "/data/develop/android/sysroot/usr/lib/alsa-lib"
